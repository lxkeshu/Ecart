          ...
          <div className={twoColumnGridClass}>
            <div className={fieldGroupClass}>
              ...
              >
                ...
                <SelectContent>
                  {categories
                    .filter((c) => c.level === 2 && c.parent === form.category)
                    .map((category) => (
                      <SelectItem key={category._id} value={category._id}>
                        {category.name}
                      </SelectItem>
            ...
            <div className={fieldGroupClass}>
              ...
              <Select
                ...
                onValueChange={(val) => updateField("subSubcategory", val)}
              ...
              >
                ...
                <SelectContent>
                  {categories
                    .filter(
                      (c) => c.level === 3 && c.parent === form.subcategory,
                    )
                    .map((category) => (
                      <SelectItem key={category._id} value={category._id}>
                        {category.name}
