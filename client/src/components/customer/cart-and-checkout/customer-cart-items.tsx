...
const wrapClass = "flex w-full lg:h-full lg:min-h-0 flex-col";
...
function CustomerCartItems() {
  ...
  return (
    <div className={wrapClass}>
      ...
      {/* Mobile: items render inline, parent handles scroll */}
      ...
      <ScrollArea className={`${scrollClass} hidden lg:block`}>
        <div className={listClass}>
          {!cart.items.length ? (
            <div className={emptyWrapClass}>
              <p className={emptyTitleClass}>Your cart is empty</p>
