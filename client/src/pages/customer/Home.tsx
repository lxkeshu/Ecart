...
const productImageWrapClass =
  "relative h-[250px] w-full overflow-hidden rounded-2xl bg-muted/30";
  ...
  return (
    <div className={pageWrapClass}>
      {data.banners.length > 0 && (
        <section className="relative w-full overflow-hidden h-[25vh] sm:h-[35vh] md:h-[70vh] bg-secondary/10">
            ...
            {data.banners.map((_, index) => (
              <button
                ...
                className={`h-2.5 rounded-full transition-all duration-300 ${
                  index === currentBanner ? "w-8 bg-primary" : "w-2.5 bg-primary/30 hover:bg-primary/50"
                }`}
      ...
      <div className={`${contentContainerClass} mt-12`}>
