...
function CategoryIcon({ name }: { name: string }) {
  ...
  if (n.includes("women")) return <ShoppingBag className="h-10 w-10 text-primary" />;
  if (n.includes("men")) return <Shirt className="h-10 w-10 text-primary" />;
  return <Grid2X2 className="h-10 w-10 text-primary" />;
}
      ...
      <div className={pageWrapClass}>
        <section className={heroSectionClass}>
          <div className={heroContainerClass}>
            <p className={heroEyebrowClass}>Collections</p>
            <div className={heroTitleWrapClass}>
              <h1 className={heroTitleClass}>Explore our collections</h1>
              <p className="text-muted-foreground mt-2">Select a category to start browsing</p>
            </div>
          </div>
        </section>
            ...
            {categories
              ...
              .map((category) => (
                <Card
                  ...
                  onClick={() => toggleFacet("category", category._id)}
                >
      ...
      <section className={heroSectionClass}>
        <div className={heroContainerClass}>
          <div className="flex flex-col gap-4">
            <Button
              variant="ghost"
              className="w-fit -ml-4 h-8 gap-2 text-muted-foreground hover:text-primary"
